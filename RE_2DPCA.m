function err=RE_2DPCA(x_noise,ix_noise,kSet)
...
for iK=1:nK
    ...
    sum=0;
    for iSub=nSub/5+1:nSub % only count the differences between normal faces and their reconstruction
